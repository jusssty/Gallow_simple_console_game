...
char gal[6][6];
vector <string> words = {"FATHER", "MOTHER", "PROGRAMMER", "NIGGA", "MATH", "ANONIMYS", "GATES", "SPOON", "ARKASHA", "PAPICH", "DOTA", "HTML", "PYTON", "ITMO",
		     			 "LIPTON", "TIKTOK", "CHURKA", "LORDRENTO", "JONGL", "CSGO", "ADOLF", "HITLER", "UKRAINA", "HOHOL", "CAP", "CAT", "ALONE", "BEER"};
